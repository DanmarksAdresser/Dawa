...
describe("Fair scheduler", () => {
  ...
  it('Should run task immediately if queue is empty',() => go(function*() {
  ...
  it('Exactly <slots> tasks should be executing', () => go(function*() {
  ...
  it('If a source1 wants to run two tasks of cost 3, and another source wants to run two tasks of cost 1, the second source should finish tasks first.', () => go(function*() {
  ...
  it('New sources may receive a head start specified by initialPriorityOffset', () => go(function*() {
  ...
  it('Should cleanup sources with priority lower than top + offest', () => go(function*() {
    scheduler = fairScheduler({
      concurrency:1,
      initialPriorityOffset: 100,
      cleanupInterval: 0
