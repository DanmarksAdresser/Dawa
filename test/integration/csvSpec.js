...
describe('CSV udtræk', function () {
  ...
  var expectedColumns = {
    ...
    adgangsadresse: ['id','status','oprettet','ændret','vejkode','vejnavn', 'adresseringsvejnavn','husnr','supplerendebynavn','postnr','postnrnavn', 'stormodtagerpostnr', 'stormodtagerpostnrnavn','kommunekode','kommunenavn','ejerlavkode','ejerlavnavn','matrikelnr','esrejendomsnr','etrs89koordinat_øst','etrs89koordinat_nord','wgs84koordinat_bredde','wgs84koordinat_længde','nøjagtighed','kilde','tekniskstandard','tekstretning','adressepunktændringsdato','ddkn_m100','ddkn_km1','ddkn_km10','regionskode','regionsnavn', 'jordstykke_ejerlavnavn','kvh','sognekode','sognenavn','politikredskode','politikredsnavn','retskredskode','retskredsnavn','opstillingskredskode','opstillingskredsnavn', 'zone', 'jordstykke_ejerlavkode', 'jordstykke_matrikelnr', 'jordstykke_esrejendomsnr', 'højde', 'adgangspunktid', 'vejpunkt_id', 'vejpunkt_kilde', 'vejpunkt_nøjagtighed', 'vejpunkt_tekniskstandard', 'vejpunkt_x','vejpunkt_y', 'afstemningsområdenummer', 'afstemningsområdenavn', 'brofast', 'supplerendebynavn_dagi_id', 'navngivenvej_id', 'menighedsrådsafstemningsområdenummer', 'menighedsrådsafstemningsområdenavn'],
    vejstykke: ['kode','kommunekode','oprettet','ændret','kommunenavn','navn','adresseringsnavn', 'navngivenvej_id', 'navngivenvej_darstatus', 'id'],
    postnummer: ['nr','navn','stormodtager', 'bbox_xmin', 'bbox_ymin', 'bbox_xmax', 'bbox_ymax', 'visueltcenter_x', 'visueltcenter_y'],
    kommune: ['dagi_id', 'kode','navn', 'regionskode', 'udenforkommuneinddeling', 'ændret', 'geo_ændret', 'geo_version', 'bbox_xmin', 'bbox_ymin', 'bbox_xmax', 'bbox_ymax', 'visueltcenter_x', 'visueltcenter_y'],
