...
describe("AdresserApi", function() {
  describe("Opslag på ID", function() {
    it("Should be possible to get an address", function(done) {
      request.get('http://localhost:3000/api/pg/adresser/0a3f50c1-d506-32b8-e044-0003ba298018', function(error, response, body) {
        expect(response.statusCode).toBe(200);
        var adresse = JSON.parse(body);
        expect(adresse.id).toBe('0a3f50c1-d506-32b8-e044-0003ba298018');
        done();
      });
    });
  });
