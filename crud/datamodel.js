module.exports = {
  adgangsadresse: {
    ...
    'matrikelnr', 'esrejendomsnr', 'adgangspunktid', 'etrs89oest', 'etrs89nord', 'noejagtighed', 'adgangspunktkilde', 'husnummerkilde', 'tekniskstandard', 'tekstretning',
      'esdhreference', 'journalnummer', 'adressepunktaendringsdato'],
    key: ['id']
  },
  adresse: {
    name: 'adresse',
