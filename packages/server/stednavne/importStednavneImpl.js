...
const { recomputeMaterialization, materialize } = require('@dawadk/import-util/src/materialize');
...
const importStednavneFromStream = (client, txid, stream, maxChanges) => go(function*() {
  ...
  const changes = yield tableDiffNg.countChanges(client, txid, tableModel.tables.stedtilknytninger);
