...
const formatAdresse = row => util.adressebetegnelse({
  vejnavn: row.navngivenvej_vejnavn,
  husnr: row.husnummer_husnummertekst,
  etage: row.adresse_etagebetegnelse,
  dør: row.adresse_dørbetegnelse,
  supplerendebynavn: row.supplerendebynavn_navn,
  postnr: row.postnummer_postnr,
  postnrnavn: row.postnummer_navn
}, false);
...
const husnummer = {
  derivedFields: [{
    fieldName: 'adressebetegnelse',
    derive: formatAdresse
  }],
  entities: [
    {
