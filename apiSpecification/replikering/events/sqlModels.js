...
const oldSqlModelNames = ['vejstykke', 'adresse', 'bebyggelsestilknytning', 'navngivenvej', 'jordstykketilknytning', 'vejstykkepostnummerrelation'];
const newSqlModelNames = ['ejerlav', 'postnummer', 'adgangsadresse'];
